...
//             <p style={{ fontStyle: "italic", color: "#6b7280", textAlign: "center" }}>No tasks</p>
//           )}
...
//               style={cardStyle}
//               onFocus={(e) => e.currentTarget.style.boxShadow = "0 4px 12px rgba(37, 99, 235, 0.6)"}
//               onBlur={(e) => e.currentTarget.style.boxShadow = "0 1px 8px rgba(0,0,0,0.15)"}
//             >
//               {item.content}
//             </div>
//           ))}
